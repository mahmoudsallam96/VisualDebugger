...
import static no.hvl.tk.visual.debugger.debugging.stackframe.StackFrameSessionListenerHelper.getIterator;
import static no.hvl.tk.visual.debugger.debugging.stackframe.StackFrameSessionListenerHelper.implementsInterface;
import static no.hvl.tk.visual.debugger.debugging.stackframe.StackFrameSessionListenerHelper.invokeSimple;
import static no.hvl.tk.visual.debugger.debugging.stackframe.StackFrameSessionListenerHelper.isInternalPackage;
...
public class TpsStackFrameAnalyzer {
  ...
  private static final Logger LOGGER = Logger.getInstance(TpsStackFrameAnalyzer.class);
  ...
  /** Used for testing. */
  protected TpsStackFrameAnalyzer(final IStackFrame stackFrame) {
    this(stackFrame, 10, new HashSet<>(), true);
  }

  /** Used for testing. */
  protected TpsStackFrameAnalyzer(final IStackFrame stackFrame, final int loadingDepth) {
